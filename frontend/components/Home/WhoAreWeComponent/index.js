...
export default function WhoAreWeComponent() {
    return (
        <section className={styles.section}>
            <div className={styles.title}>Quem somos?</div>
            <div className={styles.whoAreWeTextDiv}>
                ...
                <p>
                    Assim, através de <b>consultorias na área de Engenharia de Materiais</b> e de acordo com a
                    necessidade de cada cliente, entregamos um trabalho personalizado de excelência com impacto positivo
                    em sua empresa.
                </p>
            </div>
            <div className={styles.cardsDiv}>
                <AboutCard title={'Missão'}>
                    <p>
                        ...
                        materiais ao formar líderes e profissionais capacitados em trazer soluções eficazes aos
                        clientes.{' '}
                    </p>
                </AboutCard>
                <AboutCard title={'Visão'}>
                    <p>
                        Tornar a EJEM uma empresa referência em engenharia de materiais, no mercado e no movimento
                        empresa júnior, por meio de soluções inovadoras e de qualidade.
                    </p>
                </AboutCard>
